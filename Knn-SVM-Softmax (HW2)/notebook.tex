...
\makeatother
    ...
    \hypertarget{this-is-the-k-nearest-neighbors-workbook-for-ece-239as-assignment-2}{%
...
{\color{incolor}In [{\color{incolor}17}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np} \PY{c+c1}{\PYZsh{} for doing most of our calculations}
...
The autoreload extension is already loaded. To reload it, use:
  \%reload\_ext autoreload
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} Set the path to the CIFAR\PYZhy{}10 data}
...
Test labels shape:  (10000,)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{} Visualize some examples from the dataset.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} Subsample the data for more efficient code execution in this exercise}
...
hyperparameters via k-fold cross-validation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{} Import the KNN class}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} Declare an instance of the knn class.}
...
\def\labelenumi{(\arabic{enumi})}
\item
  In the function knn.train(), we store the whole data consisting of
  features and labels which will be used to train the knn classifier.
  This data will also be used for prediction step as well.
\item
  The cons is that we need to store the whole data and keep it for both
  training and prediction. This means that a lot of memory is needed for
  knn classifier. On the other hand, since it is based on calculation of
  norms, it is a simple algorithm, and upon good implementation
  (e.g.~vectorization instead of for loops), it is fast too.
\end{enumerate}
...
information, predict the class of the KNN.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} Implement the function compute\PYZus{}distances() in the KNN class.}
...
code by vectorizing it, removing the for loops.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{} Implement the function compute\PYZus{}L2\PYZus{}distances\PYZus{}vectorized() in the KNN class.}
...
predict the test point labels.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{c+c1}{\PYZsh{} Implement the function predict\PYZus{}labels in the KNN class.}
         ...
         \PY{n}{y\PYZus{}est} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists\PYZus{}L2\PYZus{}vectorized}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
         
         \PY{n}{y\PYZus{}diff} \PY{o}{=} \PY{p}{(}\PY{n}{y\PYZus{}test} \PY{o}{\PYZhy{}} \PY{n}{y\PYZus{}est}\PY{p}{)}
         \PY{n}{num\PYZus{}incorrect} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{count\PYZus{}nonzero}\PY{p}{(}\PY{n}{y\PYZus{}diff}\PY{p}{)}
         
         \PY{n}{error} \PY{o}{=} \PY{n}{num\PYZus{}incorrect} \PY{o}{/} \PY{n}{num\PYZus{}test}
...
k-fold cross validation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{\PYZsh{} Create the dataset folds for cross\PYZhy{}valdiation.}
         ...
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{:}
             \PY{n}{X\PYZus{}train\PYZus{}folds}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{[}\PY{n}{i}\PY{o}{*}\PY{l+m+mi}{1000}\PY{p}{:}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{*}\PY{l+m+mi}{1000}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
             \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{[}\PY{n}{i}\PY{o}{*}\PY{l+m+mi}{1000}\PY{p}{:}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{*}\PY{l+m+mi}{1000}\PY{p}{]}\PY{p}{)}
...
assess which one has the lowest k-fold cross validation error.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{n}{time\PYZus{}start} \PY{o}{=}\PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
         ...
         \PY{n}{num\PYZus{}test\PYZus{}fold} \PY{o}{=} \PY{l+m+mi}{1000}
         
         \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n}{ks}\PY{p}{:}
             \PY{n}{error2} \PY{o}{=} \PY{l+m+mi}{0}  
             \PY{n}{error1} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{:}
                 \PY{n}{knn} \PY{o}{=} \PY{n}{KNN}\PY{p}{(}\PY{p}{)}
                
                 \PY{n}{X\PYZus{}test\PYZus{}kFold} \PY{o}{=} \PY{n}{X\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{i}\PY{p}{]}
                 \PY{n}{y\PYZus{}test\PYZus{}kFold} \PY{o}{=} \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{i}\PY{p}{]}
                 
                 \PY{n}{X\PYZus{}train\PYZus{}kFold} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 \PY{n}{y\PYZus{}train\PYZus{}kFold} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 \PY{c+c1}{\PYZsh{}mask = list(range(num\PYZus{}training))}
                 \PY{c+c1}{\PYZsh{}del mask[i*1000:(i+1)*1000]}
                 
                 \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{:}
                     \PY{k}{if} \PY{n}{i} \PY{o}{!=} \PY{n}{j}\PY{p}{:}
                         \PY{n}{X\PYZus{}train\PYZus{}kFold}\PY{o}{.}\PY{n}{extend}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}
                         \PY{n}{y\PYZus{}train\PYZus{}kFold}\PY{o}{.}\PY{n}{extend}\PY{p}{(}\PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}
                 
                 \PY{n}{X\PYZus{}train\PYZus{}kFold} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}kFold}\PY{p}{)}
                 \PY{n}{y\PYZus{}train\PYZus{}kFold} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{y\PYZus{}train\PYZus{}kFold}\PY{p}{)}
                 
                 \PY{c+c1}{\PYZsh{}X\PYZus{}train\PYZus{}kFold = X\PYZus{}train[mask]}
                 \PY{c+c1}{\PYZsh{}y\PYZus{}train\PYZus{}kFold = y\PYZus{}train[mask]}
                 
                 \PY{n}{knn}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{X\PYZus{}train\PYZus{}kFold}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{y\PYZus{}train\PYZus{}kFold}\PY{p}{)}
                 
                 \PY{n}{dists\PYZus{}fold} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{compute\PYZus{}L2\PYZus{}distances\PYZus{}vectorized}\PY{p}{(}\PY{n}{X\PYZus{}test\PYZus{}kFold}\PY{p}{)}
                 \PY{n}{y\PYZus{}est\PYZus{}fold} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists\PYZus{}fold}\PY{p}{,}\PY{n}{k}\PY{p}{)}
                 \PY{n}{y\PYZus{}diff\PYZus{}fold} \PY{o}{=} \PY{p}{(}\PY{n}{y\PYZus{}test\PYZus{}kFold} \PY{o}{\PYZhy{}} \PY{n}{y\PYZus{}est\PYZus{}fold}\PY{p}{)}
                 
                 \PY{n}{num\PYZus{}correct} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{y\PYZus{}test\PYZus{}kFold} \PY{o}{==} \PY{n}{y\PYZus{}est\PYZus{}fold}\PY{p}{)}
                 \PY{c+c1}{\PYZsh{}num\PYZus{}incorrect\PYZus{}fold = np.count\PYZus{}nonzero(y\PYZus{}diff\PYZus{}fold)}
                 \PY{c+c1}{\PYZsh{}error1 = num\PYZus{}incorrect\PYZus{}fold / num\PYZus{}test\PYZus{}fold}
                 
                 \PY{n}{error1} \PY{o}{=} \PY{p}{(}\PY{n}{num\PYZus{}test\PYZus{}fold} \PY{o}{\PYZhy{}} \PY{n}{num\PYZus{}correct}\PY{p}{)}\PY{o}{/}\PY{n}{num\PYZus{}test\PYZus{}fold}
                 
                 \PY{n}{error2} \PY{o}{+}\PY{o}{=} \PY{n}{error1}
             
             \PY{n}{error}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{error2}\PY{o}{/}\PY{n}{num\PYZus{}folds}\PY{p}{)}
         
         
         \PY{k}{pass}
         
         \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{error}\PY{p}{)}\PY{p}{)}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{error}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{,}\PY{n}{ks}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}
         
         \PY{n}{x\PYZus{}index} \PY{o}{=} \PY{n}{ks}
         \PY{n}{y\PYZus{}value} \PY{o}{=} \PY{n}{error}
         \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x\PYZus{}index}\PY{p}{,} \PY{n}{y\PYZus{}value}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ro\PYZhy{}\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{35}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{k (number of neighbours)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Cross validation error}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} ================================================================ \PYZsh{}}
         \PY{c+c1}{\PYZsh{} END YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{} ================================================================ \PYZsh{}}
...
performance.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{n}{time\PYZus{}start} \PY{o}{=}\PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
         ...
         \PY{k}{for} \PY{n}{L} \PY{o+ow}{in} \PY{n}{norms}\PY{p}{:}
             \PY{n}{error2} \PY{o}{=} \PY{l+m+mi}{0}  
             \PY{n}{error1} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{:}
                 \PY{n+nb}{print}\PY{p}{(}\PY{n+nb}{str}\PY{p}{(}\PY{n}{L}\PY{p}{)}\PY{p}{,}\PY{n}{i}\PY{p}{)}
                 \PY{n}{knn} \PY{o}{=} \PY{n}{KNN}\PY{p}{(}\PY{p}{)}
                 ...
                 \PY{n}{dists\PYZus{}fold} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{compute\PYZus{}distances}\PY{p}{(}\PY{n}{X\PYZus{}test\PYZus{}kFold}\PY{p}{,}\PY{n}{L}\PY{p}{)}
                 \PY{n}{y\PYZus{}est\PYZus{}fold} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists\PYZus{}fold}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}
                 \PY{n}{y\PYZus{}diff\PYZus{}fold} \PY{o}{=} \PY{p}{(}\PY{n}{y\PYZus{}test\PYZus{}kFold} \PY{o}{\PYZhy{}} \PY{n}{y\PYZus{}est\PYZus{}fold}\PY{p}{)}
             ...
             \PY{n}{error}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{error2}\PY{o}{/}\PY{l+m+mi}{5}\PY{p}{)}
         ...
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Norm}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Validation Error}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{L1\PYZus{}norm}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{L2\PYZus{}norm}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Linf\PYZus{}norm}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} ================================================================ \PYZsh{}}
         \PY{c+c1}{\PYZsh{} END YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{} ================================================================ \PYZsh{}}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Computation time: }\PY{l+s+si}{\PYZpc{}.2f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{n}{time\PYZus{}start}\PY{p}{)}\PY{p}{)}
...
evaluate the testing error of the k-nearest neighbors model.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{n}{error} \PY{o}{=} \PY{l+m+mi}{1}
         ...
         \PY{n}{L1\PYZus{}norm} \PY{o}{=} \PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{norm}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n+nb}{ord}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
         \PY{n}{k\PYZus{}opt} \PY{o}{=} \PY{l+m+mi}{10}
         \PY{n}{L\PYZus{}opt} \PY{o}{=} \PY{n}{L1\PYZus{}norm}
         
         \PY{n}{knn}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{y\PYZus{}train}\PY{p}{)}        
         \PY{n}{dists\PYZus{}final} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{compute\PYZus{}distances}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{,}\PY{n}{L\PYZus{}opt}\PY{p}{)}
         \PY{n}{y\PYZus{}est\PYZus{}final} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists\PYZus{}final}\PY{p}{,}\PY{n}{k\PYZus{}opt}\PY{p}{)}
         
         \PY{n}{error} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{y\PYZus{}est\PYZus{}final} \PY{o}{!=} \PY{n}{y\PYZus{}test}\PY{p}{)}
